    ...
    <>
      ...
      <section className="contact " id="contactme">
        <div className=" p-12 pb-10">
          ...
          <div className=" justify-self-center md:justify-center">
              <div className="  text-4xl sm:text-2xl  lg:text-4xl  pb-5 text-[#ff6131] font-bold  wow fadeInUp">
                Contact us
              </div>
              <div className="flex mt-5 ">
                ...
                <div className="px-3 flex flex-col wow fadeInUp">
                  <div className="text-[#ff6131] font-semibold text-lg ">
                    Email Address
                  </div>
                  <a
            ...
            <div className="mx-5 sm:mx-5 sm:mt-5 mt-1 md:w-3/5 lg:px-10 tracking-wider wow fadeInUp">
              <div className="bg-white rounded-lg drop-shadow-lg p-4 ring-1 ring-[#ff6131]">
