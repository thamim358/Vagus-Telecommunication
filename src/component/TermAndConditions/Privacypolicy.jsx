    ...
    <>
      ...
      <div className="min-h-screen p-6">
        <div className="max-w-4xl mx-auto bg-white p-8 rounded shadow-md">
          <h1 className="text-3xl font-semibold mb-6 text-[#ff6131]">Privacy Policy</h1>
          ...
          <div className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-500">
              <li>Provide and improve Our services, including telecommunications solutions and support.</li>
              <li>Communicate with You regarding service updates, personalized offers, and relevant information.</li>
              {/* Add more content */}
            </ul>
            {/* Add more content */}
          </div>
          ...
          <div className="mt-8">
            ...
            <p className='text-gray-500'>
              ...
              <a href="mailto:info@vagustelecommunication.ind.in" className="text-blue-500">info@vagustelecommunications.ind.in</a>
            </p>
          </div>
        </div>
      </div>
